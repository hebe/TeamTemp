...
-- ─── Create Team ─────────────────────────────────────────────────────
insert into teams (id, name, slug, admin_token, admin_email)
values (
  '11111111-1111-1111-1111-111111111111',
  'Example Team',
  'example',
  'demo-admin-token-abc123',
  'hebedesign@gmail.com'
);
...
insert into question_set (id, team_id, is_default) values
  ('cccc0001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', true);
...
insert into rounds (id, team_id, question_set_id, token, status, scale_max, opens_at, closes_at) values
  ('dddd0001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'cccc0001-0000-0000-0000-000000000001',
   'demo-round-1', 'closed', 3, now() - interval '42 days', now() - interval '40 days');

insert into round_questions (id, round_id, question_id, kind, position) values
  ('ee010001-0000-0000-0000-000000000001', 'dddd0001-0000-0000-0000-000000000001', 'aaaa0001-0000-0000-0000-000000000001', 'fixed', 1),
  ('ee010002-0000-0000-0000-000000000002', 'dddd0001-0000-0000-0000-000000000001', 'aaaa0002-0000-0000-0000-000000000002', 'fixed', 2),
  ('ee010003-0000-0000-0000-000000000003', 'dddd0001-0000-0000-0000-000000000001', 'aaaa0003-0000-0000-0000-000000000003', 'fixed', 3),
  ('ee010004-0000-0000-0000-000000000004', 'dddd0001-0000-0000-0000-000000000001', 'aaaa0004-0000-0000-0000-000000000004', 'fixed', 4),
  ('ee010005-0000-0000-0000-000000000005', 'dddd0001-0000-0000-0000-000000000001', 'bbbb0001-0000-0000-0000-000000000001', 'rotating', 5);
...
insert into rounds (id, team_id, question_set_id, token, status, scale_max, opens_at, closes_at) values
  ('dddd0002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'cccc0001-0000-0000-0000-000000000001',
   'demo-round-2', 'closed', 3, now() - interval '28 days', now() - interval '26 days');

insert into round_questions (id, round_id, question_id, kind, position) values
  ('ee020001-0000-0000-0000-000000000001', 'dddd0002-0000-0000-0000-000000000002', 'aaaa0001-0000-0000-0000-000000000001', 'fixed', 1),
  ('ee020002-0000-0000-0000-000000000002', 'dddd0002-0000-0000-0000-000000000002', 'aaaa0002-0000-0000-0000-000000000002', 'fixed', 2),
  ('ee020003-0000-0000-0000-000000000003', 'dddd0002-0000-0000-0000-000000000002', 'aaaa0003-0000-0000-0000-000000000003', 'fixed', 3),
  ('ee020004-0000-0000-0000-000000000004', 'dddd0002-0000-0000-0000-000000000002', 'aaaa0004-0000-0000-0000-000000000004', 'fixed', 4),
  ('ee020005-0000-0000-0000-000000000005', 'dddd0002-0000-0000-0000-000000000002', 'bbbb0002-0000-0000-0000-000000000002', 'rotating', 5);
...
insert into round_questions (id, round_id, question_id, kind, position) values
  ('ee030001-0000-0000-0000-000000000001', 'dddd0003-0000-0000-0000-000000000003', 'aaaa0001-0000-0000-0000-000000000001', 'fixed', 1),
  ('ee030002-0000-0000-0000-000000000002', 'dddd0003-0000-0000-0000-000000000003', 'aaaa0002-0000-0000-0000-000000000002', 'fixed', 2),
  ('ee030003-0000-0000-0000-000000000003', 'dddd0003-0000-0000-0000-000000000003', 'aaaa0003-0000-0000-0000-000000000003', 'fixed', 3),
  ('ee030004-0000-0000-0000-000000000004', 'dddd0003-0000-0000-0000-000000000003', 'aaaa0004-0000-0000-0000-000000000004', 'fixed', 4),
  ('ee030005-0000-0000-0000-000000000005', 'dddd0003-0000-0000-0000-000000000003', 'bbbb0003-0000-0000-0000-000000000003', 'rotating', 5);

-- Round 4 (open, current)
insert into rounds (id, team_id, question_set_id, token, status, scale_max, opens_at) values
  ('dddd0004-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'cccc0001-0000-0000-0000-000000000001',
   'demo-round-4', 'open', 3, now() - interval '1 day');

insert into round_questions (id, round_id, question_id, kind, position) values
  ('ee040001-0000-0000-0000-000000000001', 'dddd0004-0000-0000-0000-000000000004', 'aaaa0001-0000-0000-0000-000000000001', 'fixed', 1),
  ('ee040002-0000-0000-0000-000000000002', 'dddd0004-0000-0000-0000-000000000004', 'aaaa0002-0000-0000-0000-000000000002', 'fixed', 2),
  ('ee040003-0000-0000-0000-000000000003', 'dddd0004-0000-0000-0000-000000000004', 'aaaa0003-0000-0000-0000-000000000003', 'fixed', 3),
  ('ee040004-0000-0000-0000-000000000004', 'dddd0004-0000-0000-0000-000000000004', 'aaaa0004-0000-0000-0000-000000000004', 'fixed', 4),
  ('ee040005-0000-0000-0000-000000000005', 'dddd0004-0000-0000-0000-000000000004', 'bbbb0004-0000-0000-0000-000000000004', 'rotating', 5);
...
declare
  ...
  rq_ids text[] := array[
    'ee010001-0000-0000-0000-000000000001',
    'ee010002-0000-0000-0000-000000000002',
    'ee010003-0000-0000-0000-000000000003',
    'ee010004-0000-0000-0000-000000000004',
    'ee010005-0000-0000-0000-000000000005'
  ];
begin
  for p in 1..5 loop
...
declare
  ...
  rq_ids text[] := array[
    ...
    'ee020002-0000-0000-0000-000000000002',
    'ee020003-0000-0000-0000-000000000003',
    'ee020004-0000-0000-0000-000000000004',
    'ee020005-0000-0000-0000-000000000005'
  ];
begin
  for p in 1..6 loop
    sub_id := gen_random_uuid();
